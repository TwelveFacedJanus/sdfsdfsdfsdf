...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#282440] flex flex-col">
      ...
      <main className="flex-1 max-w-[1920px] w-full mx-auto px-[50px] py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-white text-3xl font-bold mb-8">Политика конфиденциальности</h1>
          
          <div className="bg-[#0C1127] rounded-lg border p-8" style={{ borderColor: 'rgba(255, 255, 255, 0.05)' }}>
            <div className="prose prose-invert max-w-none">
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">1. Общие положения</h2>
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">2. Собираемая информация</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
                  При использовании Сервиса мы можем собирать следующие виды информации:
                </p>
                <ul className="list-disc list-inside text-white/80 text-base leading-relaxed mb-4 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">3. Цели обработки данных</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">4. Защита данных</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">5. Передача данных третьим лицам</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">6. Права пользователей</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">7. Cookies и аналогичные технологии</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">8. Хранение данных</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">9. Изменения в Политике конфиденциальности</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-white text-2xl font-semibold mb-4">10. Контакты</h2>
                <p className="text-white/80 text-base leading-relaxed mb-4">
                  По всем вопросам, связанным с обработкой персональных данных, вы можете обращаться:
                </p>
                <ul className="list-none text-white/80 text-base leading-relaxed space-y-2">
